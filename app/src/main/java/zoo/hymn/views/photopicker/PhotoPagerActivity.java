...
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_CURRENT_ITEM;
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_LONG_DATA;
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_PHOTOS;
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_SHOW_DELETE;
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_SHOW_SAVE;
import static zoo.hymn.views.photopicker.PhotoPreview.EXTRA_SHOW_TOOLBAR;
...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    private boolean showDelete, showToolbar,showSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showSave = getIntent().getBooleanExtra(EXTRA_SHOW_SAVE, true);
        if (!showToolbar) {
            showSave = false;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.save){
            ...
            final String savePath = pagerFragment.getPaths().get(index);

            Snackbar snackbar = Snackbar.make(pagerFragment.getView(), R.string.__picker_saved_a_photo,
                    Snackbar.LENGTH_LONG);
            snackbar.show();
            return true;
        }
