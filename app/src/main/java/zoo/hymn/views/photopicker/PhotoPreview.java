...
public class PhotoPreview {
  ...
  public final static String EXTRA_SHOW_SAVE  = "show_save";
  ...
  public static class PhotoPreviewBuilder {
    ...
    public PhotoPreviewBuilder setShowSaveButton(boolean showSaveButton) {
      mPreviewOptionsBundle.putBoolean(EXTRA_SHOW_SAVE, showSaveButton);
      return this;
    }
